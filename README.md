# ChurnMeter Pro - Real-time Customer Churn Prediction Web Application 📈📊
...
ChurnMeter Pro uses a state-of-the-art Logistic Regression and Gradient Boosting Classifiers (models) to predict customer churn. It offers a user-friendly interface for inputting customer data and receiving instant churn predictions.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/Makafui-Kwawu/ChurnMeter-Pro-Embedding-ML-models-in-Web-framework-Streamlit.git
   cd ChurnMeter-Pro-Embedding-ML-models-in-Web-framework-Streamlit
   ```
...
Contributions to the ChurnMeter-Pro project are welcome. Please follow these guidelines for contributing:
